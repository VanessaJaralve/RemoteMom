...
| Phase 3: Public Beta Readiness | Device testing | Run Expo Go local phone smoke test | In Progress |  | Open the Expo dev build on a phone and manually verify add/check/edit/delete flows, Today updates, and local persistence after closing and reopening. |
